...
En este apartado exponemos un criterio de salida de la base, al que llamamos \tbi[regla!de la razón léxico mínima]{regla de la razón léxico--mínima} o símplemente \tbi[regla!lexicográfica]{regla lexicográfica}. Lo que hace útil a este criterio es que, como veremos al finalizar la sección, es un criterio que evita la aparición de bucles, de forma que garantiza la convergencia del algoritmo a una solución óptima (cuando el problema la posea).
