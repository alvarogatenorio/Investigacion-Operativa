...
\end{figure}
Veamos una caracterización muy sencilla de las direcciones extremas para regiones factibles.
...
\begin{proof}Veamos ambas implicaciones.
	...
	\end{itemize}
\end{proof}
El lema anterior nos abre las puertas a una caracterización de las direcciones extremas mucho más potente y muy parecida al teorema \ref{fund_teo_caracterizacionExtremos}, es decir, muy poco intuitiva.
\begin{theo}[Caracterización fuerte]
	...
	\begin{equation*}
		...
		\end{array}
	\end{equation*}
	con $k=m+t$, $\alpha>0$, $B^{-1}a_k\leq 0$ y siendo $e_t$ el $t$--ésimo vector de la base canónica.
\end{theo}
\begin{proof}Veamos ambas implicaciones.
	\begin{itemize}
		\item[\bla]
